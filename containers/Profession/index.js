    ...
    return (
        <Layout title={"Profession"} className={"text-[15px]"}>
            <div className="flex flex-col gap-5 mx-auto h-max  p-4 pb-[100px]">
                ...
                <button
                    onClick={handleClick}
                    className="flex items-center font-semibold  justify-center w-full text-[20px] p-3 text-white gap-3 rounded-[15px] bg-primary1 shadow-xl/20 transition-shadow duration-300">
                    {"NEXT"}
                </button>
